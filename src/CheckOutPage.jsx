...
export default function CheckoutPage() {
  ...
  const portes = envioGratis ? 0 : 3.99;
        ...
        <div className="grid md:grid-cols-3 gap-8 items-start">
          ...
          <div className="bg-white rounded-2xl border border-[#E8F0E6] p-6 sticky top-24">
            ...
            <button onClick={finalizarEncomenda} disabled={loading}
              className={`w-full py-4 rounded-full text-xs tracking-widest uppercase transition-all shadow-lg shadow-green-900/10 ${loading ? "bg-[#C8DFC4] text-white cursor-not-allowed" : "bg-[#3D6B4A] text-white hover:bg-[#2C5038]"}`}>
