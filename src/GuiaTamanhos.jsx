export default function GuiaTamanhos({ onClose }) {
  ...
  const medidas = [
    { tamanho: "XS",  eu: "34-36", peito: "80-85",   cintura: "60-65", anca: "86-91"   },
    { tamanho: "S",   eu: "36-38", peito: "83-89",   cintura: "63-69", anca: "89-95"   },
    { tamanho: "M",   eu: "38-40", peito: "86-93",   cintura: "66-73", anca: "92-99"   },
    { tamanho: "L",   eu: "40-42", peito: "90-97",   cintura: "70-77", anca: "96-103"  },
    { tamanho: "XL",  eu: "42-44", peito: "94-101",  cintura: "74-81", anca: "100-107" },
    { tamanho: "XXL", eu: "44-46", peito: "98-105",  cintura: "78-85", anca: "104-111" },
  ];
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
          ...
          <div style={sans} className="px-8 py-6 overflow-y-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                {medidas.map((row, i) => (
                  <tr key={row.tamanho} className={`border-b border-[#E8F0E6] transition-colors hover:bg-[#F7F9F5] ${i % 2 === 0 ? "bg-white" : "bg-[#FAFCF9]"}`}>
                    <td className="py-3.5">
                      <span className="inline-flex items-center justify-center w-12 h-9 rounded-lg bg-[#E8F0E6] text-[#3D6B4A] font-semibold text-sm">
                        {row.tamanho}
                      </span>
                    </td>
